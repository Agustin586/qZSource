...
- **Dead-time**: ⏱️ Tiempo muerto entre conmutaciones

#### 🧠 Control Digital
- **DSP**: 💻 Modelado de los algoritmos de control implementados
- **PWM**: 🎛️ Generación de señales moduladas
...
- 🎚️ Cálculo de ciclo de trabajo `d0` para shoot-through
- 🎛️ Cálculo de ciclo de trabajo `d` para vector activo
...
- **🎛️ Ajuste de controladores**: Parámetros PID
- **🛡️ Verificación de protecciones**: Umbrales y tiempos
